...
- React and typesccript is pre-installed
...
- Only use "use client" in files that need it (e.g. use React hooks or browser APIs).
-Make sure it is "use client" always in double quotes
- Never add typescript quote in start and end of files keep files simple and efficient
